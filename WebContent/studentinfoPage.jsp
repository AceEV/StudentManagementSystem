    ...
    <div class="login">
      ...
      <% 	    
		...
		Connection conn = DriverManager.getConnection(url,userName,passWord);
		 String name = (String)request.getParameter("detail");
		String query = String.format("select * from registrations where username ='"+name+"'");
		...
		{%>
			...
			<tr><td>EmailId</td><td><input type="text" name="name" value="<%=rs.getString("email")%>"></td></tr>
			<tr><td>Username</td><td><input type="text" name="name" value="<%=rs.getString("username")%>"></td></tr>
			<tr><td>Password</td><td><input type="password" name="name" value="<%=rs.getString("password")%>"></td></tr>
