...
<center>
<input type="button" type="submit" onclick="window.location='result1.jsp'"  style="height:150px; width:350px" value="RESULTS"><br>
<input type="button" type="submit" onclick="window.location='StudentWelcome.jsp'"  style="height:150px; width:350px" value="ASSIGNMENTS"><br>
