...
function closeNav() {
  ...
  <section class="container">
    <div class="login">
    <h1>RESULT</h1>
<!--         <form name ="detailsFrm" action="disp1resultPage.jsp" method="post">
<p><select name="result"><br>
        <option>Select Name</option>	-->
                   <%
                        Connection connnn = DriverManager.getConnection("jdbc:mysql://localhost:3306/Mini","root","123");
String name=request.getParameter("login");
                        Statement stmt = connnn.createStatement() ;
                        query = "Select * from result where username='"+Test.userName+"'";
                        stmt=connnn.prepareStatement(query);
                        ResultSet rst2=stmt.executeQuery(query);
                        if(rst2.next())
                       {
                   %>		<tr>
							<tr><td>Name</td><td><input type="text" name="name" value="<%=rst2.getString("username")%>"></td></tr>
							<tr><td>Marks</td><td><input type="text" name="name" value="<%=rst2.getString("marks")%>"></td></tr>
							<tr><td>Grade</td><td><input type="text" name="name" value="<%=rst2.getString("grade")%>"></td></tr>
			
					<%
                        }
                   %>
   <!--    <center><p><input type="submit" name="show" value="Display"/></center> -->
</body>
</html>